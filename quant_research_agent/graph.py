...
from .agents import quant_researcher_write_notebook_node, read_paper_node, reviewer_node
...
def route_after_read_paper(state: QuantWorkflowState) -> Literal["write", "end"]:
...
def build_graph():
    """Build the notebook generation graph: read paper -> write notebook -> review/revise."""
